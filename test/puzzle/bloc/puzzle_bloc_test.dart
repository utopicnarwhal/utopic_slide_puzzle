  ...
  group('PuzzleBloc', () {
    ...
    group('PuzzleInitialized', () {
      ...
      blocTest<PuzzleBloc, PuzzleState>(
        ...
        build: () => PuzzleBloc(size: 3, random: random),
      ...
      blocTest<PuzzleBloc, PuzzleState>(
        ...
        build: () => PuzzleBloc(size: 3, random: random),
        act: (bloc) => bloc.initialize(shufflePuzzle: false),
        expect: () => [
          PuzzleState(
    ...
    group('TileTapped', () {
      ...
      blocTest<PuzzleBloc, PuzzleState>(
        ...
        build: () => PuzzleBloc(size: size),
        seed: () => PuzzleState(
          puzzle: puzzle,
          numberOfCorrectTiles: 7,
        ),
        act: (bloc) => bloc.tileTapped(middleCenterTile),
        expect: () => <PuzzleState>[
          PuzzleState(
            puzzle: Puzzle(
              tiles: [
            ...
            numberOfMoves: 1,
            tappedTilesHistory: [middleCenterTile],
          ),
        ],
      );
      ...
      blocTest<PuzzleBloc, PuzzleState>(
        ...
        act: (bloc) => bloc.tileTapped(topCenterTile),
        expect: () => <PuzzleState>[
          PuzzleState(
            puzzle: Puzzle(
              tiles: [
            ...
            numberOfMoves: 1,
            tappedTilesHistory: [topCenterTile],
          ),
        ],
      );
      ...
      blocTest<PuzzleBloc, PuzzleState>(
        ...
        act: (bloc) => bloc.tileTapped(topLeftTile),
        expect: () => [
      ...
      blocTest<PuzzleBloc, PuzzleState>(
        ...
        act: (bloc) => bloc.tileTapped(bottomRightTile),
        expect: () => [
          PuzzleState(
            puzzle: Puzzle(
              tiles: [
            ...
            numberOfCorrectTiles: 8,
            numberOfMoves: 1,
            tappedTilesHistory: [bottomRightTile],
          ),
        ],
      );
    });
